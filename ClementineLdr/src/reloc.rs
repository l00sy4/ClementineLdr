...
#[link_section = ".text"]
pub unsafe fn fix_reloc(data_directory: IMAGE_DATA_DIRECTORY, base_address: usize, relocation_address: usize) -> bool {
...
{
    pub VirtualAddress: u32, // Where the relocation must be applied
    pub SizeOfBlock: u32
}
